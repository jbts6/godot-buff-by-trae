...
description: Godot 4.7 通用开发约束（全仓库）：严格 TDD 双提交、GUT 测试约束、解析期/静态分析避坑（禁止 :=、has_property、Dictionary 点访问等）与命名规范。
---

# Godot 4.7 通用开发约束（AI Agent）

此 skill 适用于本仓库**所有模块**（ALL）。以下内容为硬约束；违反任意 “MUST/禁止” 即视为不合格产出。

---

## 内容

> 下文为完整约束正文（同步自 `docs/SKILL_GODOT47.md`）。

---

# SKILL_GODOT47 — Godot 4.7 通用开发约束（AI Agent）

> 本文档是 AI Agent 的**通用硬约束**，适用于本仓库所有模块。  
